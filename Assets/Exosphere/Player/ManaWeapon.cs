...
namespace MoreMountains.CorgiEngine
{
    ...
    [AddComponentMenu("Corgi Engine/Weapons/Mana Weapon")]
    public class ManaWeapon : Weapon
    {
        [MMInspectorGroup("Projectile Spawn", true, 65)]

        [Tooltip("Amount of mana at the start")]
        public static int manaCount = 15;

        public int ManaToTake = 1;
        ...
        {
            if (GameManager.Instance.Mana > 0)
            {
                ...
                //manaCount--;
                CorgiEngineManaEvent.Trigger(ManaMethods.Take, ManaToTake);
